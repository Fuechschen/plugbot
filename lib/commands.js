        ...
        redis.get('user:role:save:' + data.id).then(function (perm) {
            ...
            if (config.options.bouncer_plus ? (perm > 1) : (perm > 2)) {
                ...
                if (split.length === 2) {
                    ...
                    } else if(validator.isURL(split[1], {protocols: ['https'], host_whitelist: ['youtube.com', 'youtube.be', 'soundcloud.com']})){
                        var url = URL.parse(split[1]);
