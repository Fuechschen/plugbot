...
function checkRegionRestriction(body) {
    ...
    if (body.contentDetails.regionRestriction !== undefined) {
        ...
        if (body.contentDetails.regionRestriction.allowed !== undefined) {
            ...
            if (body.contentDetails.regionRestriction.blocked !== undefined) {
                //noinspection JSUnresolvedVariable
...
module.exports = {
    getSong: function (media) {
        return new Promise(function (resolve, reject) {
            request.get('https://www.googleapis.com/youtube/v3/videos?part=contentDetails,status,snippet&id=' + media.cid + '&key=' + config.apiKeys.youtube, function (err, resp, body) {
                if (!err) {
