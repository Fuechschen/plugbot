...
if(config.options.redis_substitute){
    models.Redis_Keys = sequelize.import(path.join(__dirname, 'models', 'Redis_Keys'));
    models.Redis_Sorted_Set_Element = sequelize.import(path.join(__dirname, 'models', 'Redis_Sorted_Set_Element'));
    models.Redis_Keys.hasMany(models.Redis_Sorted_Set_Element);
    models.Redis_Sorted_Set_Element.belongsTo(models.Redis_Keys);
}
