...
if(config.options.redis_substitute){
    models.Redis_Key = sequelize.import(path.join(__dirname, 'models', 'Redis_Keys'));
    models.Redis_Sorted_Set_Element = sequelize.import(path.join(__dirname, 'models', 'Redis_Sorted_Set_Element'));
    models.Redis_Hash_Element = sequelize.import(path.join(__dirname,'models','Redis_Hash_Element'));
    
    models.Redis_Key.hasMany(models.Redis_Sorted_Set_Element);
    models.Redis_Sorted_Set_Element.belongsTo(models.Redis_Key);
    
    models.Redis_Key.hasMany(models.Redis_Hash_Element);
    models.Redis_Hash_Element.belongsTo(models.Redis_Key)
}
