    ...
    constructor() {
        ...
        this.blacklist = {
            add: function (format, cid, reason) {
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    redis.hset('media:blacklist', format + ':' + cid, reason).then(function () {
                        return that.models.Song.findOrCreate({
                            where: {
                                format: format,
                                cid: cid
                            }, defaults: {
            ...
            remove: function (format, cid) {
                return new Promise(function (resolve, reject) {
                    that.models.Song.find({where: {format: format, cid: cid}}).then(function (song) {
        ...
        this.sequelize.validate().then(function () {
            story.debug('Database-Connection active.');
             return that.sequelize.sync();
        }).then(function () {
            //noinspection JSUnresolvedFunction
            return redis.del('media:blacklist').then(function () {
                //noinspection JSUnresolvedFunction
                return that.models.Song.findAll({where: {is_banned: true}});
            }).then(function (songs) {
